...
import { StyleSheet, View, Text, SafeAreaView, TouchableOpacity, ScrollView, Platform, ActivityIndicator } from 'react-native';
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const realBalance = TimeBankService.calculateBalance(hoursWorked, 8);
